...
class NanoCount:
    ...
    def __init__(
        ...
        * quiet
        ...
        # (AT)
        pkl_file_name = '/Users/arghamitratalukder/Library/CloudStorage/GoogleDrive-at3836@columbia.edu/My Drive/technical_work/RNA_Splicing/data/sim_real_data/pklfiles/fromMYPC/'
        pkl_file_name = pkl_file_name + 'ds_100_num1_aln_21_long_read_dicts.pkl'
        with open(pkl_file_name, 'rb') as file:
            self.read_dict = pickle.load(file)
    ...
    def _parse_bam(self):
        ...
        # (AT)
        # main_dir = '/Users/arghamitratalukder/Library/CloudStorage/GoogleDrive-at3836@columbia.edu/My Drive/technical_work/RNA_Splicing/data/sim_real_data/pklfiles/fromMYPC'
        # pkl_file_name_read_dict = self.alignment_file.split('/')[-1].split('.')[0] + '_read_dicts.pkl'
        # pkl_file_name_ref_len_dict = self.alignment_file.split('/')[-1].split('.')[0] + '_ref_len_dicts.pkl'
        #
