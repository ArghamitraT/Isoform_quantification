...
GDlr_val_arr = [0.01]
EM_round_arr = [3] 
experiment_num = 5      #"Different experiment setup, 1: for 1 sample, 2 for merged, 4 for multisample, 5 for merged multisample"
dirichlet_builtin = 0
simulation = 1
old_prg_file = 0
hour=1
...
readme_comment = f"trial, exp 5, simulation, name list, exp5 enabled"
if simulation:
