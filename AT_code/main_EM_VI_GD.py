...
output_file_default = os.path.join(os.getcwd(), '../../files/results/single_run/output_PacIllu_VIGD_00000')
...
parser.add_argument("--GD_lr", type=float, default=0.1, help="Learning rate for dirichlet gradient descent.")
...
Expec_Max (file_names=[sample2, sample2], count_file=output_file, GD_lr=GD_lr)
